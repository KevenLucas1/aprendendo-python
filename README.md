...
| **Módulo 03** | Estruturas de Repetição (Loops) | 🟢 Concluído | [Ver Infográfico](Estruturas de Repetição (Loops).png) |

---

### 🔍 O que abrange o Módulo 03:
* **Conceito de Loops:** O poder da repetição automatizada de blocos de código.
* **Laço `for`:** Iteração sobre sequências, listas e intervalos (`range`).
* **Laço `while`:** Execução baseada em condições dinâmicas e flags de controle.
* **Controle de Fluxo:** Utilização de `break`, `continue` e `else` dentro dos loops.
